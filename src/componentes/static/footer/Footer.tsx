                ...
                <Grid alignItems="center" item xs={12}>
                    <Box className='box1'>
                        ...
                        <Box display="flex" alignItems="center" justifyContent="center">
                            <a href="https://www.facebook.com/carol.barcellos3" target="_blank">
                                <FacebookIcon className='redes' />
                            </a>
                            <a href="https://www.instagram.com/cora.caroline_/" target="_blank">
                    ...
                    <Box className='box2'>
                        ...
                        <Box>
                            <a target="_blank" href="cora.carolineb@gmail.com">
